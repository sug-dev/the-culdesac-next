...
export default function Search({ text, func, currentUser }: SearchProps) {
    ...
    return (
        <div className='sm:overflow-x-scroll overflow-y-hidden bg-white dark:bg-neutral-950 flex items-center gap-9 relative'>
            ...
            <button className={`fixed right-3 ${isOpen ? `top-[50px] sm:top-[105px]` : 'top-[0px] sm:top-[55px]'} bg-neutral-950 rounded-b-lg px-6 py-2 z-10 font-bold text-neutral-300 text-lg`}onClick={() => {setIsOpen(!isOpen)}}>
